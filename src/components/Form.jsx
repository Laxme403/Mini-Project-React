                ...
                <div className='mt-8 flex justify-between items-center'>
                    <div>
                        <input
                            ...
                            id='remember'
                        />
                        <label className='mt-2 font-medium text-base' for="remember">Remember Me</label>
                    </div>
                    <button className='font-medium text-base text-blue-600'>Forgot password</button>
                </div>
                <div className='mt-8 flex flex-col gap-y-4'>
                    <button className='active:scale-[.95] active:duration-75 hover:scale-[1.01] ease-in-out transition-all py-3 rounded-xl bg-black text-slate-100 text-lg font-bold'>Sign in</button>
                </div>
